...
Tools: PostgreSQL · SQL (CTEs, Window Functions, Self-Joins, Conditional Aggregation) Dataset: Online Retail II (UCI Machine Learning Repository) — ~1.07M transactions, Dec 2009–Dec 2011, UK-based online gift retailer
...
When do customers stop coming back, and how much retention is lost early vs. late?
Is customer retention improving or worsening over time?
Which cohorts generate the most value — and is that a fair comparison?
Which customers should the business prioritize retaining, winning back, or converting?
